...
const AdminTrainersManagement = () => {
    ...
    const handleDelete = (trainerId) => {
        axios.delete(`http://localhost:8080/deleteTrainer/${trainerId}`)
            .then((response) => {
                console.log(response.data);
                // Refresh the list of trainers after deletion
                fetchData();
            })
            .catch((error) => {
                console.log(error.message);
...
export default AdminTrainersManagement